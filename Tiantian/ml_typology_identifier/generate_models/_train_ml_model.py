...
def train_ml_model(path_model_parameters_json, path_folder_sub_model, num_epochs=10, batch_size=1, learning_rate=0.0001, continue_training=False):
    """
    ...
    with open(os.path.join(path_model_parameters_json[0:len(path_model_parameters_json)-17],"model_training_param.txt"),"w") as training_par_file :
