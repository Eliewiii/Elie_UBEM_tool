...
class Typology:
    ...
    def from_json(cls,path):
        ...
        If some parameter are not available in the json file and are critical for the simulation, default values will be set
        * path      : path to the json file containing the typology details
        ...
        with open(path + "//typo_details.json", 'r') as f:
            ...
            try :
                ...
                print('Typology "{}" does not have a year, it will be set as 2000 by default'.format(typo_obj.identifier) )
                typo_obj.year = 2000
                ...
                if (isinstance(json_dict["year"],int) or isinstance(json_dict["year"],float))  and json_dict["year"]>0 :
                    ...
                    print('Typology "{}" year is not correct, it will be set as 2000 by default'.format(typo_obj.identifier))
                    typo_obj.year = 2000
            ...
            try :
                ...
                print('Typology "{}" does not have number of apartment per floor, it will be set as None by default'.format(typo_obj.identifier) )
                ...
                if isinstance(json_dict["nb apartments per floor"],int) and json_dict["nb apartments per floor"]>=0 :
                    ...
                    print('Typology "{}" number of apartment per floor is not correct, it will be set as None by default'.format(typo_obj.identifier))
                    typo_obj.nb_apartments_per_floor = None
            ### nb_cores_per_floor ###
            try :
                json_dict["nb cores per floor"]
            except:
                print('Typology "{}" does not have a nb_cores_per_floor, it will be set as None by default'.format(typo_obj.identifier) )
                ...
                if isinstance(json_dict["nb cores per floor"],int) and json_dict["nb cores per floor"]>=0 :
                    ...
                    print('Typology "{}" nb_cores_per_floor is not correct, it will be set as None by default'.format(typo_obj.identifier))
                    typo_obj.nb_cores_per_floor = None
            ### use ###
            try :
                json_dict["use"]
            ...
            try :
                ...
                print('Typology "{}" does not have window_floor_area_ratio_per_direction, it will be set as [0,0,0.1,0] by default'.format(typo_obj.identifier) )
                ...
                try:
                    ...
                    print('Typology "{}" window_floor_area_ratio_per_direction is not correct, it will be set as [0,0,0.1,0] by default'.format(typo_obj.identifier))
                    typo_obj.window_floor_area_ratio_per_direction = {"north": 0, "east": 0.2, "south": 0, "west": 0}
                else:
            ...
            try :
                ...
                try :
                    ...
                    print('Typology "{}" does not have shading type, it will be set as "no_shading" by default'.format(typo_obj.identifier) )
                    ...
                    if json_dict["shade parameters"]["shading type"] in ShadeType._member_names_ :
                        ...
                        print('Typology "{}" shading type is not correct, it will be set as "no_shading" by default'.format(typo_obj.identifier))
                        typo_obj.use = ShadeType.no_shade.name
